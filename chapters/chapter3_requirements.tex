...
The model identifies four human actors: donor, center staff, center administrator, and super administrator. Emergency creation is available within authorized operational workflows. The system itself performs scheduled and event-driven work such as session expiry, eligibility restoration, donor scanning, ranking, escalation, notification retry, deadline expiry, forecasting, and audit logging.
...
Usability & Provide role-focused workflows and clear status feedback & Angular layouts, feature pages, shared status and empty-state components\\ \hline
Testability & Support automated checks at service and component boundaries & Maven tests and Angular test configuration\\ \hline
...
\endhead
E1 & Identity and security & Verified account, login, reset, roles, protected routes & Must\\ \hline
E2 & Donor onboarding & Health, blood type, location, availability, preferences & Must\\ \hline
E3 & Center management & Center approval, staff, operating hours, slots & Must\\ \hline
E4 & Appointment lifecycle & Booking, rescheduling, check-in, screening, completion & Must\\ \hline
E5 & Donor engagement & History, eligibility, certificates, impact, reliability & Should\\ \hline
E6 & Emergency management & Creation, deadline, progress, resolution, history & Must\\ \hline
E7 & Matching engine & Compatibility, availability, distance, ranking, escalation & Must\\ \hline
E8 & Notification engine & Alerts, retries, preferences, WebSocket updates & Must\\ \hline
E9 & Administration & Users, roles, restrictions, GDPR, audit & Must\\ \hline
E10 & Analytics and reporting & Center and system summaries, exports & Should\\ \hline
E11 & Industrialization & CI/CD, containers, k3s deployment & Should\\ \hline
E12 & Observability & Metrics, dashboards, logs, traces & Should\\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[height=0.54\textheight]{assets/methodology/Kanban-process.png}
\caption[Kanban process]{Kanban process visual reused from the preferred reference report}
...
\diagram[0.30\textheight]{increment-roadmap}{Functional dependency roadmap for Kanban increments}
