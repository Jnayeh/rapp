...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.99\textwidth,height=0.90\textheight]{diagrams/rendered/usecasediagram.png}
  \caption{Global Qatra use-case diagram}
\end{figure}
\newpage
...
\diagram[0.58\textheight]{global-domain-model}{Global Qatra class diagram}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,height=0.33\textheight,keepaspectratio]{diagrams/rendered/hexagonal-architecture.png}
  \caption{Appointment module architecture}
\end{figure}
...
\caption{Physical k3s deployment in \texttt{qatra} namespace}
